...
BEFORE INSERT OR UPDATE ON kofirmanda
FOR EACH ROW EXECUTE FUNCTION check_batisa_before_kofirmanda();
...
INSERT INTO statut_membre (code, description) VALUES
('ACTIF', 'Membre actif du Fiangonana'),
('VAHINY', 'Personne de passage ou invité'),
('DECHU', 'Membre déchu');

-- Insertion des statuts pour statut_marial
INSERT INTO statut_marial (code, description) VALUES
...
INSERT INTO statut_batisa (code, description) VALUES
('FAIT', 'Baptême effectué'),
('NON_FAIT', 'Baptême non effectué');

-- Insertion des statuts pour statut_kofirmanda
INSERT INTO statut_kofirmanda (code, description) VALUES
('FAIT', 'Confirmation effectuée'),
('NON_FAIT', 'Confirmation non effectuée');

-- Insertion des statuts pour statut_mariage
INSERT INTO statut_mariage (code, description) VALUES
('MARIAGE', 'Mariage'),
('REMARIAGE', 'Remariage');

-- Insertion des statuts pour statut_sortie
INSERT INTO statut_sortie (code, description) VALUES
('TEMPORAIRE', 'Sortie temporaire'),
('DEFINITIF', 'Sortie définitive');

-- Insertion des statuts pour statut_membre_sampana
INSERT INTO statut_membre_sampana (code, description) VALUES
('ACTIF', 'Membre actif du Sampana'),
